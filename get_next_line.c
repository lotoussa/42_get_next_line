...
/*                                                 #+#   #+    #+    #+#      */
/*   Created: 2017/11/28 19:58:03 by lotoussa     #+#   ##    ##    #+#       */
/*   Updated: 2017/11/30 15:32:21 by lotoussa    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int		ft_recupline(char **save, char *next, char **line)
{
	char	*tmp;
...
int		ft_multi_fd(int fd, char **line, char **save)
{
	t_content		a;
	char			*tmp;
